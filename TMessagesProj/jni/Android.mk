# We need to do this strange MY_LOCAL_PATH thing, because otherwise
# including subfolder Android.mk files breaks in very weird ways:
...
LOCAL_STATIC_LIBRARIES := webp sqlite tgnet avformat avcodec avresample avutil swresample voip flac
