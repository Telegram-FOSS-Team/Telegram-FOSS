...
- **SECURITY:** BoringSSL bundled source and binaries are replaced with upstream OpenSSL source code built at compile time
- **SECURITY:** Old FFmpeg prebuilts are replaced with the newest source code built at compile time
- **SECURITY:** Bundled SQLite is updated
- **SECURITY:** Bundled libWebP is updated

*Removal of non-FOSS, untrustworthy or suspicious binaries or source code and their functionality:*
- Google Breakpad native dependency(not used)
...
3. Build native FFmpeg dependency:
      - Go to the `TMessagesProj/jni` folder and execute the following (define the path to your NDK installation):
